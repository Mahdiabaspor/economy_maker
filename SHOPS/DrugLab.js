...
const SellToDrugLab = [
  // Raw materials (lowest value)
  {
    itemName: "item_weed",
    label: "WEED",
    singlePrice: Math.floor(700 * drugLabBuyMulti), // Raw material - Player gets 700 per item (pure profit as it's foraged)
  },
  {
    itemName: "item_coca_leaves",
    label: "COCA LEAVES",
    singlePrice: Math.floor(750 * drugLabBuyMulti), // Raw material - Player gets 750 per item (pure profit as it's foraged)
  },
  {
    itemName: "item_saffarole_leave",
    label: "SAFFAROLE LEAVE",
    singlePrice: Math.floor(800 * drugLabBuyMulti), // Raw material - Player gets 800 per item (pure profit as it's foraged)
  },
  ...
  // Intermediate products (medium value)
  {
    ...
    label: "SAFFAROLE OIL",
    singlePrice: Math.floor(1800 * drugLabBuyMulti), // Crafting cost: ~1600 (2 saffarole leaves at 800) = 200 profit per item (12.5% margin)
  },
  {
    itemName: "item_methylamine_crystal",
    label: "METHYLAMINE CRYSTAL",
    singlePrice: Math.floor(4800 * drugLabBuyMulti), // Crafting cost: ~4200 (3 methanol + 2 ammonia) = 600 profit per item (14% margin)
  },
  {
    itemName: "item_cocain_powder",
    label: "COCAINE POWDER",
    singlePrice: Math.floor(3400 * drugLabBuyMulti), // Crafting cost: ~2066 = 1334 profit per item (65% profit margin)
  },
  {
    itemName: "item_mdp2p",
    label: "MDP2P",
    singlePrice: Math.floor(4200 * drugLabBuyMulti), // Crafting cost: ~2400 = 1800 profit per item (75% profit margin)
  },
  ...
  // Final products (highest value)
  {
    ...
    label: "COCAINE PACK",
    singlePrice: Math.floor(5500 * drugLabBuyMulti), // Crafting cost: ~2500 = 3000 profit per item (120% profit margin)
  },
  {
    itemName: "item_mdma_powder",
    label: "MDMA POWDER",
    singlePrice: Math.floor(5800 * drugLabBuyMulti), // Crafting cost: ~3266 = 2534 profit per item (78% profit margin)
  },
  {
    itemName: "item_mdma_pill",
    label: "MDMA PILL",
    singlePrice: Math.floor(7500 * drugLabBuyMulti), // Crafting cost: ~4250 = 3250 profit per item (100% profit margin)
  },
];
