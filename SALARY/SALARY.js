...
export const governmentSalary = {
  ...
  ems: {
    Intern: Math.floor((baseSalary * 1.0) / 4), // افزایش حقوق
    Nurse: Math.floor((baseSalary * 1.3) / 4),
    Doctor: Math.floor((baseSalary * 1.6) / 4),
    Chief: Math.floor((baseSalary * 1.8) / 4), // افزایش حقوق
  },
};
