export const CraftingGangConfig = {
  gang_drug_crafting: [
    {
      ...
      materials: [{ itemName: "item_battery", count: 4, label: "BATTERY" }],
      itemType: "RARE",
      craftTimeMinutes: 3,
      output: 2,
      requiredGangLevel: 1,
  ...
  gang_weapon_crafting: [
    {
      label: "Lock Pick", //4125
      itemName: "item_lock_pick",
      materials: [
        { itemName: "item_bar_iron", count: 1, label: "IRON BAR" },
        { itemName: "item_broken_lock_pick", count: 2, label: "BROKEN LOCK PICK" },
        { itemName: "item_fabric", count: 1, label: "FABRIC" },
      ],
      itemType: "RARE",
      craftTimeMinutes: 3,
      output: 1,
...

    {
      ...
      materials: [{ itemName: "item_bar_iron", count: 5, label: "IRON BAR" }],
      itemType: "RARE",
      craftTimeMinutes: 3,
      output: 1,
      requiredGangLevel: 1,
